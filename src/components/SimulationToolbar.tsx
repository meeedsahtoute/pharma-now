    ...
    <div className="fixed bottom-4 right-4 z-50">
      {!isOpen ? (
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-slate-900 border-2 border-emerald-500/80 text-emerald-400 text-xs font-bold shadow-2xl hover:scale-105 transition-all"
        >
        ...
        <div className="w-80 sm:w-96 bg-slate-900/95 border border-slate-700 rounded-3xl p-5 shadow-2xl backdrop-blur-xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="py-3 space-y-3 text-xs">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 font-semibold border border-slate-700 transition"
            >
