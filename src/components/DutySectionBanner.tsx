...
export const DutySectionBanner: React.FC<DutySectionBannerProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-4">
      <div className="rounded-3xl bg-white dark:bg-slate-900 text-slate-900 dark:text-white p-6 sm:p-8 border border-slate-200 dark:border-slate-800 shadow-xl relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 relative z-10">
          ...
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-xs font-bold uppercase tracking-wider mb-3">
              <Moon className="w-3.5 h-3.5 fill-emerald-600 dark:fill-emerald-400" />
            ...
            <div className="flex items-center gap-4 text-xs font-semibold text-slate-500 dark:text-slate-400 mt-4 flex-wrap">
          ...
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/80 max-w-xs text-xs text-slate-700 dark:text-slate-300 shadow-sm">
